...
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (1,1,TIMESTAMP '2024-03-22 08:15:47.321');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (2,5,TIMESTAMP '2024-09-10 19:42:03.875',TIMESTAMP '2024-09-12 13:42:03.875');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (2,5,TIMESTAMP '2024-10-10 19:42:03.875');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (3,2,TIMESTAMP '2025-01-05 13:07:29.045',TIMESTAMP '2025-01-06 08:27:39.045');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (4,3,TIMESTAMP '2024-12-01 23:59:59.999');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (5,3,TIMESTAMP '2024-07-18 05:30:11.210');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (6,4,TIMESTAMP '2024-08-09 11:25:33.456',TIMESTAMP '2024-08-12 21:25:33.456');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (7,2,TIMESTAMP '2025-02-27 16:44:12.789');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (8,4,TIMESTAMP '2024-10-14 03:19:55.102');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada) values (9,2,TIMESTAMP '2024-11-05 22:08:01.670');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (10,5,TIMESTAMP '2025-04-18 09:12:47.888',TIMESTAMP '2025-04-23 19:16:47.888');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (6,2,TIMESTAMP '2024-08-13 13:45:33.456',TIMESTAMP '2024-08-16 11:25:33.456');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (6,1,TIMESTAMP '2024-08-22 17:13:33.456',TIMESTAMP '2024-08-23 21:44:33.456');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (6,3,TIMESTAMP '2024-08-26 08:23:33.456',TIMESTAMP '2024-08-30 23:54:33.456');
INSERT INTO TB_MOTO_PATIO(id_moto,id_patio,data_hora_entrada,data_hora_saida) values (6,1,TIMESTAMP '2024-09-02 13:30:33.456',TIMESTAMP '2024-09-07 10:48:33.456');
